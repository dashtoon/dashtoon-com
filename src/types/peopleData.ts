...
export const peopleData: Person[] = [
    ...
    { id: 5, name: 'Anmol Chawla', position: 'Engineer', imageSrc: require('../assets/images/PhotosOfPeople/Anmol Chawla - Engineer.png') },
    ...
    { id: 13, name: 'Mohammad Zaryab', position: 'Product Engineer', imageSrc: require('../assets/images/PhotosOfPeople/Mohammad Zaryab - Product Engineer.png') },
