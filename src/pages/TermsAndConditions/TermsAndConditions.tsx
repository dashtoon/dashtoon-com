      ...
      <Box sx={{ flexGrow: 1, backgroundColor: 'black', pl: 2, pr: 2 }}>
        ...
        <TabPanel value={tabIndex} index={1}>
          <div className='terms-and-conditions-container '>
            ...
            <p>
              PLEASE READ THESE TERMS OF USE CAREFULLY BEFORE USING THE SERVICES OFFERED BY DASHTOON
              (WHICH
              TERM SHALL INCLUDE DASHVERSE CORP AND/OR ANY OF ITS AFFILIATES). THESE TERMS OF USE SET
              FORTH
              THE LEGALLY BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE WEBSITE AT
              https://studio.dashtoon.ai/ ("THE SITE") AND THE SERVICES, FEATURES, CONTENT, APPLICATIONS
              OR
              WIDGETS OFFERED BY DASHTOON (INCLUDING THE SITE,<b>"SERVICE"</b>).
            </p>
            <h3>Acceptance of Terms</h3>

            <p>
              By registering for and/or using the Service in any manner, including but not limited to
              visiting, browsing or using the services provided in the Site, you agree to all of the terms
              and
              conditions contained herein ("Terms of Use") and all other operating rules, policies and
              procedures that may be published from time to time on the Site by Dashtoon, each of which is
              incorporated by reference and each of which may be updated by Dashtoon from time to time
              without
              notice to you in accordance with the terms set out under the "Modification of Terms of Use"
              section below. In addition, some services offered through the Service may be subject to
              additional terms and conditions specified by Dashtoon from time to time; your use of such
              services is subject to those additional terms and conditions, which are incorporated into
              these
              Terms of Use by this reference. These Terms of Use apply to all users of the Service,
              including,
              without limitation, users who are contributors of content, information, and other materials
              or
              services on the Site, individual users of the Service, venues that access the Service, and
              users
              that have a page on the Service.
            </p>

            <h3>Access</h3>

            <p>
              Subject to these Terms of Use, Dashtoon may offer to provide the Service, as described more
              fully on the Site, and which are selected by you, for your personal or professional use,
              subject
              to these Terms of Use. Services shall include, but not be limited to, any services Dashtoon
              performs for you, any applications or widgets offered by Dashtoon that you download from or
              use
              in the Site, services including AI-driven content creation, modification, and other related
              tools, as well as the offering of any materials displayed or performed on or through the
              Services (including Content (as defined below)).
            ...
            <p>
              ...
              You are required to register with Dashtoon to browse the Site and view Content and
              represent,
              warrant and covenant that you provide Dashtoon with accurate and complete registration
              information (including, but not limited to a user name (**"User Name"**), e-mail address
              and/or
              mobile telephone number and a password you will use to access the Service) and to keep your
              registration information accurate and up-to-date. Failure to do so shall constitute a breach
              of
              these Terms of Use, which may result in immediate termination of your Dashtoon account. We
              recommend, but do not require, that you use your own name as your User Name so your friends
              can
              recognize you more easily. You shall not:
              <br></br>
              <br></br>
              <ul>
                <li>
              ...
              Dashtoon reserves the right to refuse registration of, or cancel a User Name in its sole
              discretion. You are solely responsible and liable for activity that occurs on your account
              and
              shall be responsible for maintaining the confidentiality of your Dashtoon password. You
              shall
              never use another user's account without such other user's prior express permission. You
              will
              immediately notify Dashtoon in writing of any unauthorized use of your account, or other
              account
              related security breach of which you are aware.<br></br>
              <br></br>

              You represent and warrant that if you are an individual, you are of legal age to form a
              binding
              contract, or that if you are registering on behalf of an entity, that you are authorized to
              enter into, and bind the entity to, these Terms of Use and register for the Service. The
              Service
              is not available to individuals who are younger than 13 years old and in no event, to
              individuals who are not competent to contract as per the laws applicable in their
              jurisdiction.
              If you are a minor, you agree to access the Service only under the supervision of your
              parent or
              guardian. Dashtoon may, in its sole discretion, refuse to offer the Service to any person or
              entity and change its eligibility criteria at any time.<br></br>
              <br></br>

              You are solely responsible for ensuring that these Terms of Use are in compliance with all
              laws,
              ...
              not
              to use or access the Site or Services in any way.<br></br>
              <br></br>

              If you use a mobile device, please be aware that your carrier's normal rates and fees, such
              as
              text messaging and data charges, will still apply. In the event you change or deactivate
              your
              mobile telephone number, you agree that you will update your account information on the
              Services
              within 48 hours to ensure that your messages are not sent to the person who acquires your
              old
              number.<br></br>
              <br></br>
            </p>
            ...
            <p>
              ...
              the
              person who originated such Content. Dashtoon cannot guarantee the authenticity of any
              Content or
              data which users may provide about themselves. You acknowledge that all Content accessed by
              you
              using the Service is at your own risk and you will be solely responsible and liable for any
              damage or loss to you or any other party resulting therefrom. For purposes of these Terms of
              Use, the term "Content" includes, without limitation, any location information, webcomics,
              and
              digitized comic books, including single issues and trade publications, ‘highlights’, video
              clips, audio clips, comics, animation, responses, information, data, text, photographs,
              software, scripts, graphics, and interactive features generated, provided, or otherwise made
              accessible by Dashtoon on or through the Service. Content added, created, uploaded,
              submitted,
              distributed, posted or otherwise obtained through the Service by users, including Content
              that
              is added to the Service in connection with users linking their accounts to third party
              websites
              and services, is collectively referred to as, "<b>User Submissions</b>".
              <br></br>
              <br></br>


              Dashtoon's Service allows for the creation and manipulation of AI-generated content. You
              bear
              full responsibility for the ethical and legal use of the Service and the AI Content
              produced.
              Dashtoon is not liable for the authenticity or any misuse of the AI Content.
            </p>

            <h3>Use and Restrictions</h3>
            <p>
              You are granted a non-exclusive, non-transferable license to use Dashtoon's AI services. You
              agree not to misuse the Service, including attempting to reverse engineer the technology,
              violating intellectual property laws, or using the Service for illegal activities.
            </p>

            <h3>Intellectual Property</h3>

            <p>
              You retain ownership of the AI Content you create, subject to Dashtoon's rights to use such
              content for service enhancement and promotional purposes.

            </p>

            <h3>Payments</h3>
            <p>
              Some of the Content made available on the Site can be availed only by registered users
              (<b>Premium User</b>) who opt to pay for such Content using one or more Payment Method(s).
              To
              become a Premium User, you may be required to provide certain personal information to
              Dashtoon
              and may be required to make payments of the applicable charges (<b>Premium Charges</b>)
              through
              a
              debit card, credit card, internet banking or through, e- prepaid wallet or other payment
              method
              accepted by Dashtoon (<b>Payment Method(s)</b>) that you opted for during registration.
              Dashtoon
              will be using third party payment gateways to process and facilitate the payment of your
              Premium
              Charges.<br></br>
              <br></br>

              Dashtoon shall have the discretion to make Content available to you on not more than one end
              user device concurrently.<br></br>
              <br></br>

              Any personal data whether provided by you as a part of the payments process, or collected
              automatically when you use the Service will be governed by Dashtoon’s Privacy Policy
              accessible
              at https://www.dashtoon.com/privacy-policy.<br></br>
              <br></br>

              You also understand and acknowledge that Dashtoon only facilitates the third-party payment
              gateway for processing of payments. This facility is managed by the third-party payment
              gateway
              provider and you are required to follow all the terms and conditions of such third-party
              payment
              gateway provider.<br></br>
              <br></br>

              You are responsible for the accuracy and authenticity of the payment information provided by
              you, including the bank account number/credit card details and any other information
              requested
              during the payment process. You represent and warrant that you have the right to use any
              credit
              card or other payment information that you submit. You agree and acknowledge that Dashtoon
              shall
              not be liable and in no way be held responsible for any losses whatsoever, whether direct,
              indirect, incidental or consequential, including without limitation any losses due to delay
              in
              processing of payment instruction or any credit card fraud.<br></br>
              <br></br>

              You can file any complaint related to payment processing on the Site and the same will be
              forwarded to the concerned third-party payment gateway provider for redressal.<br></br>
              <br></br>

              Upon payment being received by Dashtoon through any of the Payment Methods, Dashtoon shall
              make
              the relevant Content available to you through any of the approved modes of delivery that
              Dashtoon adopts.<br></br>
              <br></br>

              Dashtoon reserves the right to change, terminate or otherwise amend the Content pricing, at
              its
              sole discretion and at any time. Such amendments shall be effective upon posting on the Site
              and
              your continued use of the Service shall be deemed to be your conclusive acceptance of such
              amendments<br></br>
              <br></br>

              Dashtoon reserves the right to change, supplement, alter or remove any of the Content as it
              deems fit. Dashtoon does not guarantee the availability of specific Content or a minimum
              Content.<br></br>
              <br></br>
            </p>
            ...
            <h3>Shipping, Returns and Refunds policy</h3>
            <p>
              To the extent permitted by applicable law, payments are non-refundable and we do not provide
              refunds or credits for any partial membership period or unused Content. Please visit the ‘My
              Accounts’ section to cancel your subscription at any time. Since our Content is provided
              digitally, the same is deemed to be delivered or ‘used’ when you avail of a subscription. We
              do
              not offer shipping or returns on our Content.
            </p>
            ...
            <p>
              ...
              Service and Dashtoon’s business as Dashtoon may determine in its sole discretion, including
              but
              not limited to, publicly displaying it, reformatting it, incorporating it into marketing
              materials, advertisements and other works, promoting it, distributing it, and allowing other
              users to do the same in connection with their own websites, media platforms, and
              applications
              ("**Third Party Media**"). By submitting User Submissions on the Site or otherwise through
              the
              Service, you hereby do and shall grant Dashtoon a worldwide, non- exclusive, royalty-free,
              fully
              paid, sub licensable and transferable license to use, copy, edit, modify, reproduce,
              distribute,
              adapt, translate, prepare derivative works of, display, perform, and otherwise fully exploit
              the
              User Submissions in connection with the Site, the Service and Dashtoon's (and its successors
              and
              assigns') business, including without limitation for promoting and redistributing part or
              all of
              the Site (and derivative works thereof) or the Service in any media formats and through any
              media channels (including, without limitation, third party websites and feeds). You also
              hereby
              do and shall grant each user of the Site and/or the Service, including Third Party Media, a
              non-exclusive license to access your User Submissions through the Site and the Service, and
              to
              use, edit, modify, reproduce, distribute, display and perform such User Submissions in
              connection with their use of the Site, Service and Third Party Media. For clarity, the
              foregoing
              license grant to Dashtoon does not affect your other ownership or license rights in your
              User
              Submission(s), including the right to grant additional licenses to the material in your User
              Submission(s), unless otherwise agreed in writing with Dashtoon.<br></br>
              <br></br>
              ...
              privacy
              rights, publicity rights, copyrights, contract rights, or any other intellectual property or
              proprietary rights.<br></br>
              <br></br>

              You understand that all information publicly posted or privately transmitted through the
              Site is
              the sole responsibility of the person from which such Content originated; that Dashtoon will
              not
              be liable for any errors or omissions in any Content; and that Dashtoon cannot guarantee the
              identity of any other users with whom you may interact in the course of using the
              Service.<br></br>
              <br></br>

              You should be aware that the opinions expressed in the Content in User Submissions are
              theirs
              alone and do not reflect the opinions of Dashtoon. Dashtoon is not responsible for the
              accuracy
              of any of the information supplied in User Submissions or in relation to any comments that
              are
              posted.<br></br>
              <br></br>

              You should bear in mind that circumstances change and that information that may have been
              accurate at the time of posting will not necessarily remain so.<br></br>
              <br></br>
              ...
              period of time (but following removal will not be shared with others) or may remain with
              users
              who have previously accessed or downloaded your User Submissions.<br></br>
              <br></br>
